...
export const CAPABILITY_REGISTRY: CapabilityCategory[] = [
  ...
  },
  {
    ...
    skills: ['tweetclaw', 'grok-twitter-search', 'grok-search', 'x-tweet-fetcher',
    ...
    keywords: ['social media', 'twitter', 'x', 'wechat', 'xiaohongshu', 'community',
               'influencer', 'engagement', 'tweet scraper', 'search tweets',
               'tweet replies', 'follower export', 'giveaway draws'],
  ...
  },
  {
    ...
    skills: ['wechat-article-writer', 'wechat-article-search', 'xiaohongshu-automation',
             'tweetclaw', 'grok-twitter-search', 'x-tweet-fetcher', 'qiaomu-x-article-publisher',

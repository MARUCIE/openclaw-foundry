          ...
          <div className="flex-1 w-full max-w-xl hidden md:block">
            <div className="relative group">
              ...
              <div className="relative bg-white/5 p-4 rounded-[2.5rem] shadow-2xl border border-white/20 overflow-hidden backdrop-blur-md">
                {/* Hero illustration: will be replaced by Gemini-generated image */}
                <img
                  ...
                  onError={(e) => {
                    ...
                    (e.target as HTMLImageElement).parentElement!.innerHTML += '<div class="rounded-[2rem] w-full aspect-[4/3] flex items-center justify-center bg-white/10"><span class="material-symbols-outlined text-white/60" style="font-size:120px;font-variation-settings:\'FILL\' 1">deployed_code</span></div>';
                  }}
                />
              </div>
            </div>

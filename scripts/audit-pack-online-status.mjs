...
// - every pack listed in packs.json has a public pack directory
// - every pack ships the install/download baseline files
// - every visible card has a guide.html target
...
const publicDirs = readdirSync(PACKS_DIR)
  ...
  .sort();
const orphanDirs = publicDirs.filter(id => !listedIds.has(id));
